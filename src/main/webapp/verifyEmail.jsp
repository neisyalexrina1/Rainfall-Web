<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <head>
            ...
            <title>Xác nhận Email - Rainfall Analytics</title>
            ...
            <style>
                ...
                .otp-digit:focus {
                    ...
                    background: #fff;
                    box-shadow: 0 0 0 3px rgba(11, 108, 179, 0.15);
                }
            ...
            <div class="container min-vh-100 d-flex flex-column" style="flex: 1;">
                <div class="auth-container" style="flex:1;">
                    <div class="auth-card text-center" style="margin: auto; max-width: 460px;">
                        ...
                        <div style="width:64px;height:64px;border-radius:50%;background:linear-gradient(135deg,#0b6cb3,#0284c7);
                    display:flex;align-items:center;justify-content:center;margin:0 auto 1.25rem;
                    box-shadow:0 8px 20px rgba(11,108,179,0.3);">
                            <i class="fa-solid fa-envelope-open-text" style="font-size:1.6rem;color:#fff;"></i>
                        </div>

                        <h2 class="mb-2">Xác nhận Email</h2>
                        ...
                        border-radius:6px;text-align:left;color:#065f46;font-size:0.875rem;margin-bottom:1rem;">
                                ...
                                <form action="AuthServlet" method="POST" onsubmit="collectOtp()">
                                    ...
                                    <%-- 6 digit boxes --%>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block" id="verifyBtn" disabled>
                                            <i class="fa-solid fa-check-circle me-1"></i> Xác nhận tài khoản
                                        </button>
                                </form>
                            </c:if>
                            <c:if test="${not empty otpExpired}">
                                <p class="text-muted" style="font-size:0.875rem;margin-top:1rem;">
                                    Mã đã hết hạn. <a href="register.jsp">Đăng ký lại</a>
                                </p>
                            </c:if>
                            ...
                            <div style="margin-top:1.5rem;font-size:0.875rem;color:var(--text-muted);">
                                ...
                                <form action="AuthServlet" method="POST" style="display:inline;">
                                    <input type="hidden" name="action" value="resend_register_otp">
                            ...
                            <p style="margin-top:1.5rem;font-size:0.875rem;color:var(--text-muted);">
                                <a href="register.jsp"><i class="fa-solid fa-arrow-left me-1"></i>Quay lại đăng ký</a>
                            </p>
                    </div>
                </div>
            </div>
